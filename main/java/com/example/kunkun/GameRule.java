...
public class GameRule extends Activity implements View.OnTouchListener {
    ...
    public void backToHomePage(View view) {
        Intent intent = new Intent(GameRule.this, MainActivity.class);
        startActivity(intent);
    }


    public void reStart(View view) {
        Intent intent = new Intent(GameRule.this, GameRule.class);
        startActivity(intent);
    }

    public void advert(View view) {
        Intent intent = new Intent(GameRule.this, AdvertActivity.class);
        startActivity(intent);
    }
    ...
    private void getPosition() {
        ...
        LinearLayout touch = findViewById(R.id.touch);
    ...
    public boolean onTouch(View view, MotionEvent event) {
        ...
        // 图片位置
        ImageView winGame = findViewById(R.id.cxk);
        ...
        if (distance > 1000) {
            ...
            try {
                ...
                Thread.sleep(2000);
                System.out.println(new Date());
                Intent intent = new Intent(GameRule.this, SuccessFindKunkun.class);
                startActivity(intent);
            ...
            System.out.println("播放第" + distance / 100 + "个音频");

            final int soundId0 = sp.load(this, music[distance / 100], 1);
            sp.setOnLoadCompleteListener(new SoundPool.OnLoadCompleteListener() {
